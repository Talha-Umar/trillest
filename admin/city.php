              ...
              <div class="card-header">
                <div class="row" style="padding: 10px 20px;">
                    <div class="col-md-6 col-sm-6 col-6">
                      <h3 class="card-title">Cities Information</h3> 
                    </div>
                    <div class="col-md-6 col-md-6 col-sm-6 col-6" style="text-align: right;">
                      <button type="button" class="btn btn-success " data-toggle="modal" data-target="#add"><i class="fa fa-plus-circle"> Add City</i>
                      </button>
                  </div>
                </div>
              ...
              <div class="card-body">
                ...
                <?php
                    if (isset($_POST['update'])) {
                      $Category=$_POST['Category'];
                      $uid=$_POST['uid'];
                      $sql = "UPDATE `cities` SET `name`='$Category' WHERE id='$uid'";
