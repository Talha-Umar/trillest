        ...
        <div class="container">
          <div class="row">
            <div class="col-md-6">
              ...
              <span style="margin-left: 20px;"><?php echo $row['username']; ?></span><br><br>
              <strong>Email:</strong>
    ...
    <?php 
       if(isset($_POST['profile'])){
           $upid = $_POST['upid'];
            ...
            $query = mysqli_query($conn," UPDATE admin SET username = '$name', email = '$email', mobile = '$phone', password = '$password', profile_image = '$path' WHERE id ='$upid'");
