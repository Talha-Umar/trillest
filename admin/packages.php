          ...
          <div class="col-12">
                ...
                <?php
                    if (isset($_POST['update'])) {
                      $Cid=$_POST['Cid'];
                       ...
                       $Price=$_POST['Price'];
                       $Description=$_POST['Description'];                      
                      $sql = "UPDATE package SET cat_id='$Cid', name='$Name',price='$Price',description='$Description' WHERE id='$uid'";
                          ...
                          <div class="modal-content">
                            ...
                            <div class="card card-primary">
                              <div class="card-body">
                                ...
                                <div class="form-group">
                                  <label>Name</label>
                                  <input type="text" class="form-control"  placeholder="Enter Package Name" name="Name" id="name" required>
                                </div>

                                <div class="form-group">
                                  <label>Price</label>
                                  <input type="number" class="form-control"  placeholder="Enter Package Price" name="Price" id="price" required>
                                </div>
            ...
            <?php 
              if (isset($_POST['delete'])) {
                $did=$_POST['did'];
                $sql = "DELETE FROM package WHERE id='$did'";
